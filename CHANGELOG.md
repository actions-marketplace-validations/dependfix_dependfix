...
* **docs:** M26.3 C69 2 个 summary-sync en-US md 翻译（architecture + platform-ai-integration） ([175c709](https://github.com/dependfix/dependfix/commit/175c709))
* **docs:** M26.3 C69 2 个 summary-sync en-US md 翻译（governance/index + spec-and-doc-governance） ([d5e6786](https://github.com/dependfix/dependfix/commit/d5e6786))
* **docs:** M26.3 C69 5 个 must-sync en-US md 翻译 ([1b43cf5](https://github.com/dependfix/dependfix/commit/1b43cf5))
* **docs:** M26.3 C69 VitePress 多语言脚手架 ([4dfd630](https://github.com/dependfix/dependfix/commit/4dfd630))
...
* **i18n:** i18n-anchor-check 工具脚本 + CI 集成（locale 对称性检查） ([80912c2](https://github.com/dependfix/dependfix/commit/80912c2))
* **i18n:** M26.3 C69 check:readme-i18n 脚本 + npm script ([b31f5a8](https://github.com/dependfix/dependfix/commit/b31f5a8))
...
* **deps:** 升级 devalue 修复 DoS 漏洞 ([f991caf](https://github.com/dependfix/dependfix/commit/f991caf))
* **deps:** 回退 @vitest/coverage-v8 到 vitest 4 配套版本 ([f9976c7](https://github.com/dependfix/dependfix/commit/f9976c7))
* **design:** Manifest flow 评估报告修正 GHES 版本断言 + OAuth 认证描述 ([700ab28](https://github.com/dependfix/dependfix/commit/700ab28))
* **design:** 删除 §2.6 重复小节标题 ([ac21f6f](https://github.com/dependfix/dependfix/commit/ac21f6f))
* **docs:** audit W1 修复 auto-merge.md 注册 vitepress sidebar ([c9939cb](https://github.com/dependfix/dependfix/commit/c9939cb))
* **docs:** M26.3 en-US/index.md YAML 半角冒号导致 vitepress build 失败 ([4be6e52](https://github.com/dependfix/dependfix/commit/4be6e52))
* **docs:** 修复 markdown 裸 HTML 标签触发 VitePress build 失败 ([9649869](https://github.com/dependfix/dependfix/commit/9649869))
* **docs:** 修复 roadmap.md `<code>` 裸标签破坏 docs:build ([c89c233](https://github.com/dependfix/dependfix/commit/c89c233))
...
* **standards:** 修正经验教训沉淀 commit 引入的断链 ([edef93b](https://github.com/dependfix/dependfix/commit/edef93b))
